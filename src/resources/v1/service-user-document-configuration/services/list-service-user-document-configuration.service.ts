...
import { serviceUserDocConfigListResponse } from "../service-user-document-configuration.response";
import { serviceUserDocConfigErrorsMessages } from "../service-user-document-configuration.messages";

class ListServiceUserDocumentConfigurationService {
  ...
  async execute(
    ...
    try {
      ...
      const data = {
        ...
        from: 1 + offset,
        rows: serviceUserDocConfigListResponse(configs),
      };
...
export default new ListServiceUserDocumentConfigurationService();
