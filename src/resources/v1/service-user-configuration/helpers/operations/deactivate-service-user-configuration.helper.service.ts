...
class DeactivateServiceUserConfigurationHelperService {
  public async execute(
    ...
    try {
      if (!existing.is_active || existing.is_deleted) {
        throwError(
          ...
          ResponseBuilder.error(ErrorTypes.CONFLICT, {
            message: "Service user configuration is already inactive",
      ...
      rethrowIfKnown(error, "Error while deactivating service user configuration", errorMap);
    }
  }
}

export default new DeactivateServiceUserConfigurationHelperService();
