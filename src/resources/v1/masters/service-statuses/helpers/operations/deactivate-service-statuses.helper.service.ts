...
class deactivateServiceStatusesHelperService {
  constructor() {}
  ...
  public async execute(
    ...
    try {
      if (!existing.is_active || existing.is_deleted) {
        throwError(
          ...
          ResponseBuilder.error(ErrorTypes.CONFLICT, {
            message: "Service status is already inactive",
      ...
      rethrowIfKnown(error, "Error while deactivating service status", errorMap);
    }
  }
}

export default new deactivateServiceStatusesHelperService();
