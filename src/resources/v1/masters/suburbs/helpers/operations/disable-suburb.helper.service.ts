...
class disableSuburbHelperService {
  constructor() {}
  ...
  public async execute(
    ...
    try {
      if (!existing.is_active || existing.is_deleted) {
        throwError(
          ...
          ResponseBuilder.error(ErrorTypes.CONFLICT, {
            message: "Suburb is already inactive",
      ...
      rethrowIfKnown(error, "Error while disabling suburb", errorMap);
    }
  }
}

export default new disableSuburbHelperService();
