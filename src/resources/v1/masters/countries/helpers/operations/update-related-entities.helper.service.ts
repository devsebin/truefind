...
class updateRelatedEntitiesHelperService {
  private regionModel: Model<IRegion>;
  ...
  // Deactivates regions, districts, and suburbs when the country is disabled or deleted
  public async deactivate(
    ...
    try {
      ...
      rethrowIfKnown(error, "Error while deactivating country related entities", countryErrorsMessages);
    }
  }

  // Activates regions, districts, and suburbs when the country is enabled/activated
  public async activate(
    ...
    try {
      ...
      rethrowIfKnown(error, "Error while activating country related entities", countryErrorsMessages);
    }
  }
}
