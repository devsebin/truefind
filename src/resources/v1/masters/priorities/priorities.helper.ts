...
import {
    ...
    prioritiesSuccessMessages,
} from "./priorities.messages";

export function prioritiesPayload(
    type: keyof typeof prioritiesSuccessMessages,
    data: any = [],
    DbTransaction: DbTransaction[] = [],
) {
    const { message, status } = prioritiesSuccessMessages[type];
    return {
...
export function throwError<T = any>(
    message: keyof typeof prioritiesErrorsMessages,
    data: ApiResponse<T>,
): never {
