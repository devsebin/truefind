...
import deactivateBundlesHelperService from "../helpers/operations/deactivate-bundles.helper.service";
...
class disableBundlesService {
  public async execute(
    ...
    try {
      ...
      await findBundlesStateHelperService.isAlreadyInactive(
        bundle[0],
        bundlesErrorsMessages,
      );

      await deactivateBundlesHelperService.execute(
        bundle[0],
        session,
        userId,
        dbTransactions,
...
export default new disableBundlesService();
