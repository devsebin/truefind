...
class ActivateCarouselHelperService {
  constructor() {}
  ...
  public async execute(
    ...
    try {
      if (existing.is_active && !existing.is_deleted) {
        throwError(
          ...
          ResponseBuilder.error(ErrorTypes.CONFLICT, {
            message: "Carousel is already activated",
      ...
      rethrowIfKnown(error, "Error while activating carousel", errorMap);
    }
  }
}

export default new ActivateCarouselHelperService();
