...
class ActivateCurrencyHelperService {
  constructor() {}
  ...
  public async execute(
    ...
    try {
      if (existing.is_active) {
        throwError(
          ...
          ResponseBuilder.error(ErrorTypes.CONFLICT, {
            message: "Currency is already active",
      ...
      rethrowIfKnown(error, "Error while enabling currency", errorMap);
    }
  }
}

export default new ActivateCurrencyHelperService();
