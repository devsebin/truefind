...
import deactivateCurrencyHelperService from "../helpers/operations/deactivate-currencies.helper.service";
import { currencyResponse } from "../currencies.response";

class DisableCurrenciesService {
  public async execute(
    ...
    try {
      ...
      const saved = await deactivateCurrencyHelperService.execute(
        existing,
        session,
        dbTransactions,
        currenciesErrorsMessages
...
export default new DisableCurrenciesService();
