...
class deleteServiceDocumentHelperService {
  constructor() {}
  ...
  public async execute(
    ...
    try {
      if (existing.is_deleted) {
        throwError(
          ...
          ResponseBuilder.error(ErrorTypes.CONFLICT, {
            message: "Service document is already deleted",
      ...
      rethrowIfKnown(error, "Error while deleting service document", errorMap);
    }
  }
}

export default new deleteServiceDocumentHelperService();
