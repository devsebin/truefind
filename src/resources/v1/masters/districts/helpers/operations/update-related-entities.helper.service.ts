...
class updateRelatedEntitiesHelperService {
  ...
  // Deactivates suburbs when the district is disabled or deleted
  public async deactivate(
    ...
    try {
      ...
      rethrowIfKnown(error, "Error while deactivating district related entities", districtErrorsMessages);
    }
  }

  // Activates suburbs when the district is enabled/activated
  public async activate(
    ...
    try {
      ...
      rethrowIfKnown(error, "Error while activating district related entities", districtErrorsMessages);
    }
  }
}
