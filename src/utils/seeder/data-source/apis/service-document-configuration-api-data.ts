...
const serviceDocumentConfigurationApiData = (): IAPI[] => [
    // Create / Store
    {
        ...
        url: "/api/v1/service-document-configurations",
        status: true,
        form_params: [],
        search_params: [],
        access_params: {},
    ...
    // Show
    {
        ...
        activity_method: apiMethods.GET,
        url: "/api/v1/service-document-configurations/:id",
        status: true,
        form_params: [],
        search_params: [],
        access_params: {},
    ...
    // Enable
    {
        ...
        url: "/api/v1/service-document-configurations/:id/enable",
        status: true,
        form_params: [],
        search_params: [],
        access_params: {},
    ...
    // Disable
    {
        ...
        activity_method: apiMethods.PATCH,
        url: "/api/v1/service-document-configurations/:id/disable",
        status: true,
        form_params: [],
        search_params: [],
        access_params: {},
